...
#if defined(CONFIG_S3C2410) || defined(CONFIG_S3C2416)
...
typedef struct {
	...
	S3C24X0_REG32	GPJUP;
	S3C24X0_REG32	GPJSEL;
	S3C24X0_REG32	GPKCON;
	S3C24X0_REG32	GPKDAT;
	S3C24X0_REG32	GPKUP;
	S3C24X0_REG32	res13;
	S3C24X0_REG32	GPLCON;
	S3C24X0_REG32	GPLDAT;
	S3C24X0_REG32	GPLUP;
	S3C24X0_REG32	GPLSEL;
	S3C24X0_REG32	GPMCON;
	S3C24X0_REG32	GPMDAT;
	S3C24X0_REG32	GPMUP;
	S3C24X0_REG32	res14;
	S3C24X0_REG32	DSC3;
	S3C24X0_REG32	PDDMCON;
	S3C24X0_REG32	PDSMCON;
#endif
